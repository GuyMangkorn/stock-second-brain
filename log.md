...
- `etf-performance`: Sequential queue row `9/125` completed for `AIA`; refreshed [[ETF_NASDAQ_AIA Performance]] with official rolling 10-year NAV TR cumulative `298.99%` / CAGR `14.84%`, 2021-2025 rows, current date-to-date YTD `40.47%` as of 2026-07-21, updated [[Asia ex Japan ETF]] / [[ETF Performance Index]], and extended [[ETF_performance_sources_2026-07-23]]. Next queue ticker: `ASEA`.
