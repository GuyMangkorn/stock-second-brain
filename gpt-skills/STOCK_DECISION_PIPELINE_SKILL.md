# Stock Decision Pipeline Skill

> GPT-ready export from `.codex/skills/stock-decision-pipeline/SKILL.md`.
...
- Original folder: `stock-decision-pipeline`
- Original name: `stock-decision-pipeline`
