...
workers for the same board. The board-scoped manager lock above is the
enforceable runtime serialization boundary; the lane reread remains the
per-card claim confirmation.
