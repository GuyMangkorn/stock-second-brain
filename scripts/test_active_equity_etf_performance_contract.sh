...
assert_contains "$skill_file" 'research-queue-manager'
assert_contains "$skill_file" 'research_handoff'
...
assert_contains "$workflow_file" 'Research Queue handoff'
assert_contains "$workflow_file" 'durable-write-complete'
