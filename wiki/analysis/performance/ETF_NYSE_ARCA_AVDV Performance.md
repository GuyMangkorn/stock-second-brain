...
calendar_years_as_of: 2026-07-09 secondary
...
- Current official YTD ณ 2026-07-31: NAV TR `+13.11%`; market-price TR `+12.97%`. ณ 2026-08-14 NAV `US$110.80` และ market price `US$110.86`.
...
Risk evidence is `not-verified` for official daily NAV max drawdown, recovery date, and recovery duration. The secondary proxy window available through 2026-07-09 shows observed maximum drawdown `-14.17%` from the 2025-03-19 peak to 2025-04-07 and a later `-5.35%` drawdown from the 2026-05-26 peak; this is not an official daily NAV series. Main exposures are foreign small-cap, value, country/FX, liquidity, and active-process risk. The SEC summary prospectus reports latest fiscal-year portfolio turnover of `4%`.
...
- [Secondary dividend-reinvested return series](https://totalrealreturns.com/n/AVDV%2CAVUV%2CFIVA%2CAVNV%2CVXUS) — calendar proxy and observed drawdown window; not official NAV evidence.
