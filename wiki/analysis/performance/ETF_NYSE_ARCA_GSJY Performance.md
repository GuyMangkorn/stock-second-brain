...
GSJY ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD: ไม่พบข้อมูลที่ยืนยันได้.
...
GSJY เป็น passive/index-tracking equity ETF ใน primary region Japan. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: current performance and annual rows not disclosed.

## Sources

- Official issuer source: https://am.gs.com/public-assets/documents/5747f795-24d6-11ef-870d-ed3a247c783e
