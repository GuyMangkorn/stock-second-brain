...
KCAI ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ 4.27% ณ 2026-06-30.
...
- Current YTD: 4.27% as of 2026-06-30

## Risk read-through

KCAI เป็น passive/index-tracking equity ETF ใน primary region China. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: new fund; calendar rows and net expense not disclosed.

## Sources

- Official issuer source: https://kraneshares.com/etf/kcai/
