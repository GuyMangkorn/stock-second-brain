...
ticker: EPP
exchange: NYSE Arca
fund: iShares MSCI Pacific Ex-Japan Index Fund
...
EPP ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ 10.77% ณ 2026-07-17.
...
- Current YTD: 10.77% as of 2026-07-17

## Risk read-through

EPP เป็น passive/index-tracking equity ETF ใน primary region Asia-Pacific. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: annual rows and raw 10Y endpoints not disclosed.

## Sources

- Official issuer source: https://www.ishares.com/us/products/239674/ishares-msci-pacific-ex-japan-etf
