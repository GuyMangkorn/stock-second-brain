...
SPSM เป็น passive/index-tracking U.S. small-cap equity ETF ที่ติดตาม S&P SmallCap 600 Index. Official issuer รายงาน 10-year NAV Total Return annualized `10.75%` และ current NAV YTD `21.54%` ณ 2026-07-31. Issuer ยังไม่เปิดเผย raw endpoints หรือ annual calendar rows ใน capture ที่ตรวจสอบ.
...
- Current refresh: the issuer performance table provides rolling/period returns through 2026-07-31 and fund facts through 2026-08-15; it still does not provide SPSM calendar-year NAV rows for 2016-2025 or raw 10-year endpoints.
