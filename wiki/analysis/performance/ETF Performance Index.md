...
- [[ETF_NYSE_ARCA_GWX Performance]] — GWX (International; issuer 10-year NAV TR average annual `7.58%` and current official NAV TR YTD `+8.18%` as of 2026-06-30; official calendar rows, raw endpoints, and daily NAV drawdown/recovery remain disclosed gaps, with a conflicting secondary annual table excluded)
