...
- [[ETF_NYSE_ARCA_IEUR Performance]] — IEUR (Europe; official `NYSE Arca:IEUR`; official 2021-2025 NAV TR cumulative `+60.39%` / rounded-input CAGR `+9.91%`, issuer rolling 10-year NAV TR `+10.02%` as of 2026-06-30, and current official NAV TR YTD `+12.03%` as of 2026-08-17; 2025 `+35.11%` / 2022 `-16.18%`, 13.67% 3-year standard deviation, semi-annual distributions, USD S&P reference and daily NAV drawdown/recovery gaps disclosed)
