...
- [[ETF_NYSE_ARCA_IEV Performance]] — IEV (Europe; official `NYSE Arca:IEV`; official 2021-2025 NAV TR cumulative `+64.33%` / rounded-input CAGR `+10.44%`, issuer rolling 10-year NAV TR `+9.87%` as of 2026-06-30, and current official NAV TR YTD `+11.94%` as of 2026-08-17; 2025 `+35.02%` / 2022 `-14.16%`, 13.38% 3-year standard deviation, semi-annual distributions, USD S&P reference and daily NAV drawdown/recovery gap disclosed)
