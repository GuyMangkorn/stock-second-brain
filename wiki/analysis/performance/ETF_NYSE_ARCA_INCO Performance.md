...
INCO ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD: ไม่พบข้อมูลที่ยืนยันได้.
...
INCO เป็น passive/index-tracking equity ETF ใน primary region India. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: inception, fee, current performance and annual rows not disclosed.

## Sources

- Official issuer source: https://www.columbiathreadneedleus.com/investment-products/mutual-funds/columbia-india-consumer-etf/class-/details?cusip=19762B707
