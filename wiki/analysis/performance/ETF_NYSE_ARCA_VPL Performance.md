...
VPL ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ 28.39% ณ 2026-05-31.
...
- Current YTD: 28.39% as of 2026-05-31

## Risk read-through

VPL เป็น passive/index-tracking equity ETF ใน primary region Asia-Pacific. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: current NAV and annual rows not disclosed.

## Sources

- Official issuer source: https://investor.vanguard.com/investment-products/etfs/profile/vpl
