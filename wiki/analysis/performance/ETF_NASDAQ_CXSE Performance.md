...
CXSE ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ -3.69% ณ 2026-06-30.
...
- Current YTD: -3.69% as of 2026-06-30

## Risk read-through

CXSE เป็น passive/index-tracking equity ETF ใน primary region China. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: annual rows and raw 10Y endpoints not disclosed.

## Sources

- Official issuer source: https://www.wisdomtree.com/us/products/equity/cxse
