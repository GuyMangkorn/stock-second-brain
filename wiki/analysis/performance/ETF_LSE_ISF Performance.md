...
product-page NAV TR YTD คือ `10.51%` ณ 17 ส.ค. 2026; July factsheet ก่อนหน้า
รายงาน `11.42%` ณ 31 ก.ค. 2026.
...
- Latest official product-page snapshot: NAV `£10.48` as of 18 ส.ค. 2026; NAV TR YTD `10.51%` as of 17 ส.ค. 2026; 100 holdings as of 17 ส.ค. 2026; share-class net assets `£16,350.96m` as of 18 ส.ค. 2026; 12-month trailing distribution yield `2.91%` as of 17 ส.ค. 2026.
...
- Latest official product-page NAV TR YTD: `+10.51%` as of 17 ส.ค. 2026; the July factsheet's earlier YTD observation was `+11.42%` as of 31 ก.ค. 2026.
...
portfolio had 100 holdings as of 17 ส.ค. 2026, with sector weights Financials
`28.72%`, Industrials `14.15%`, Consumer Staples `13.21%`, Health Care `11.33%`,
and Energy `10.62%`. UK/country, GBP share-class and sector concentration risks
...
- [iShares Core FTSE 100 factsheet, July 2026](https://www.blackrock.com/uk/literature/fact-sheet/isf-ishares-core-ftse-100-ucits-etf-fund-fact-sheet-en-gb.pdf) — official 2016-2025 NAV/index rows, rolling returns, structure and trading information as of 31 Jul 2026
