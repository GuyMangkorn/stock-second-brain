...
GMF ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ 12.56% ณ 2026-06-30.
...
- Current YTD: 12.56% as of 2026-06-30

## Risk read-through

GMF เป็น passive/index-tracking equity ETF ใน primary region Asia-Pacific. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: annual rows and current YTD refresh not disclosed.

## Sources

- Official issuer source: https://www.ssga.com/us/en/intermediary/etfs/state-street-spdr-sp-emerging-asia-pacific-etf-gmf
