...
- `entity_key: Cboe BZX:NOBL`
- Fund: ProShares S&P 500 Dividend Aristocrats ETF
- Inception: `2013-10-09`; expense ratio: `0.35%`
- Metric: `NAV Total Return` รวม distributions reinvested และ fund expenses
- Issuer benchmark: S&P 500 Dividend Aristocrats Index
- Common benchmark: `S&P 500 Total Return` (USD, dividends reinvested)
- 10-year NAV TR CAGR: `9.62%` as of `2026-03-31` (official rolling issuer figure)
...
- Current YTD: `3.62%` as of `2026-05-31`
...
- [Official issuer product/performance source](https://www.proshares.com/our-etfs/strategic/nobl)
