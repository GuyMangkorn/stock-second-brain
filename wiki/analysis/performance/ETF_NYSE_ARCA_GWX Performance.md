...
GWX เป็น passive/index-tracking international small-cap equity ETF ที่ติดตาม S&P Developed Ex-U.S. Under USD2 Billion Index. Official issuer รายงาน 10-year NAV Total Return average annual `7.58%` และ current NAV YTD `8.18%` ณ 2026-06-30. Official capture ที่ตรวจสอบยังไม่เปิดเผย annual calendar rows จึงคำนวณ 2021-2025 CAGR หรือ up/down-year ranking ไม่ได้โดยไม่ผสมข้อมูลคนละฐาน.
...
- 10-year NAV TR CAGR: `7.58%` (official issuer average annual total return; retained as a source fact, not recomputed from undisclosed endpoints)
...
- Current YTD: `8.18%` NAV TR as of 2026-06-30; market-value return `8.52%` and issuer-index return `6.77%` are kept separate and are not substituted for NAV TR

## Risk read-through

GWX ให้ international small-cap exposure ผ่าน passive sampling ของ S&P Developed Ex-U.S. Under USD2 Billion Index. Gross expense ratio คือ `0.40%` และ holdings คือ `2,083` ณ 2026-06-30. Official factsheet รายงาน 1-year NAV TR `21.24%`, 3-year `15.84%`, 5-year `5.32%`, และ 10-year `7.58%` ณ วันเดียวกัน; SEC prospectus ที่สิ้นสุด 2025-12-31 รายงาน 10-year NAV TR `7.00%`, ซึ่งเก็บเป็น separate as-of observation ไม่ใช่ conflict ที่นำมาผสม. Prospectus ยังเปิดเผย best quarter `+20.78%` ใน Q2 2020 และ worst quarter `-28.37%` ใน Q1 2020.
...
- Current refresh: the official June 2026 factsheet provides standardized rolling/period returns through 2026-06-30, but it does not provide GWX calendar-year NAV rows for 2016-2025 or raw 10-year endpoints.
...
- [Official GWX issuer product page](https://www.ssga.com/us/en/individual/etfs/state-street-spdr-sp-international-small-cap-etf-gwx) — identity, passive objective, exchange, inception, index, fund facts and performance context; accessed 2026-08-17
- [Official GWX factsheet](https://www.ssga.com/library-content/products/factsheets/etfs/us/factsheet-us-en-gwx.pdf) — NAV/market-value/index standardized returns and fund characteristics; as of 2026-06-30; accessed 2026-08-17
