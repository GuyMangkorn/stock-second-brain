...
DGIN ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ -12.56% ณ 2026-06-22.
...
- Current YTD: -12.56% as of 2026-06-22

## Risk read-through

DGIN เป็น passive/index-tracking equity ETF ใน primary region India. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: current data stale; annual rows not disclosed.

## Sources

- Official issuer source: https://www.vaneck.com/us/en/investments/digital-india-etf-dgin/overview/
