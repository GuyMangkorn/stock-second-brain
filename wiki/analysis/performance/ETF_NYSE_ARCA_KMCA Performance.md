...
KMCA ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ -5.14% ณ 2026-06-30.
...
- Current YTD: -5.14% as of 2026-06-30

## Risk read-through

KMCA เป็น passive/index-tracking equity ETF ใน primary region South Korea. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: new fund; no complete annual history.

## Sources

- Official issuer source: https://plusetf.com/kmca
