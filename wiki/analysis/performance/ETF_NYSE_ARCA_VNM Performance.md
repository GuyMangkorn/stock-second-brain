...
VNM ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ -2.31% ณ 2026-06-23.
...
- Current YTD: -2.31% as of 2026-06-23

## Risk read-through

VNM เป็น passive/index-tracking equity ETF ใน primary region Vietnam. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: inception, fee, annual rows not disclosed; current snapshot stale.

## Sources

- Official issuer source: https://www.vaneck.com/us/en/investments/vietnam-etf-vnm/
