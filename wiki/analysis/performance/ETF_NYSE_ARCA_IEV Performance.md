...
current official NAV TR YTD คือ `+11.94%` ณ 17 ส.ค. 2026. Issuer rolling
...
- Expense ratio: `0.60%`; official NAV `US$75.37` และ closing price `US$75.42` ณ 17 ส.ค. 2026; net assets `US$1.692B` ณ วันเดียวกัน.
- Current official NAV TR YTD: `+11.94%` ณ 17 ส.ค. 2026. Official 1Y/3Y/5Y/10Y annualised NAV TR คือ `18.26% / 16.07% / 9.64% / 9.87%` ณ 30 มิ.ย. 2026.
...
- Current YTD: `+11.94%` as of 17 ส.ค. 2026
...
held 360 positions ณ 17 ส.ค. 2026, with country exposure to the United Kingdom
`22.90%`, France `15.31%`, Switzerland `14.14%`, Germany `13.55%`, and the
Netherlands `8.76%`. Main risks are European country/sector concentration,
