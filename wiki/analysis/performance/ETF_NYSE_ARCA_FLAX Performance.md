...
FLAX ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ 22.35% ณ 2026-07-10.
...
- Current YTD: 22.35% as of 2026-07-10

## Risk read-through

FLAX เป็น passive/index-tracking equity ETF ใน primary region Asia ex Japan. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: annual rows not disclosed; fund under 10 years; current snapshot stale.

## Sources

- Official issuer source: https://www.franklintempleton.com/investments/options/exchange-traded-funds/products/26346/SINGLCLASS/franklin-ftse-asia-ex-japan-etf/FLAX
