...
DBJP ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD: ไม่พบข้อมูลที่ยืนยันได้.
...
DBJP เป็น passive/index-tracking equity ETF ใน primary region Japan. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: annual NAV rows and current NAV/YTD not disclosed.

## Sources

- Official issuer source: https://etf.dws.com/en-us/AssetDownload/Index/f0a852db-a1b3-40a7-8a97-5dca027cf1b0/DBJP-Fact-Sheet.pdf
