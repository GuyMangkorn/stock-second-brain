...
CNYA ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD คือ 1.13% ณ 2026-07-17.
...
- Current YTD: 1.13% as of 2026-07-17

## Risk read-through

CNYA เป็น passive/index-tracking equity ETF ใน primary region China. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: annual rows and raw 10Y endpoints not disclosed.

## Sources

- Official issuer source: https://www.ishares.com/us/products/273318/ishares-msci-china-a-etf
