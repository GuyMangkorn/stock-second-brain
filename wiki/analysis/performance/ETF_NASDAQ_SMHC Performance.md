...
SMHC ยังมี annual NAV Total Return ที่ยืนยันได้ไม่ครบจาก official source รอบนี้ จึงไม่จัดอันดับ best/worst และไม่คำนวณ CAGR จากข้อมูลที่ขาด. Current NAV YTD: ไม่พบข้อมูลที่ยืนยันได้.
...
SMHC เป็น passive/index-tracking equity ETF ใน primary region China. Expense ratio, issuer benchmark, daily NAV Total Return drawdown และ recovery: not disclosed in this compact capture. ข้อจำกัดสำคัญ: new fund; no complete annual history and current YTD not disclosed.

## Sources

- Official issuer source: https://www.vaneck.com/us/en/investments/china-semiconductor-etf-smhc/
