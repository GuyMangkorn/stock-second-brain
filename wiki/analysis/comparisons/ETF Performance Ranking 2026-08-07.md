...
- Universe: `143` current performance owner pages → `60` eligible pages (`17` USA, `43` non-U.S.). Percentile universe ใช้ eligible 60 pages ร่วมกันในแต่ละปี.
...
มี `83` exclusions จาก current owner pages. Raw one-row-per-candidate ledger อยู่ที่ [[ETF_performance_ranking_sources_2026-08-07]]. เหตุผลด้านล่างคง wording เดียวกับ audit ledger.
...
| [[ETF_AMEX_DGS Performance|DGS]] | `NYSE Arca:DGS` | Emerging Markets | +14.91% | +35.48% | -15.39% | +17.28% | +4.14% | +15.60% | -12.15% | +18.92% | +2.13% | +20.40% | O10 / OD0 / S0 / AI0 | 49.0678 | 29.4407 | 8 | 3 | 15.0000 | 2018 -15.39% | 14.7540 | 46.6102 | 4.6610 | 53.3898 | 2.6695 | 7.3305 | 51.7712 |
...
| [[ETF_AMEX_DLS Performance|DLS]] | `NYSE Arca:DLS` | International | +7.00% | +30.95% | -18.69% | +22.11% | -1.23% | +11.66% | -17.36% | +15.40% | +3.24% | +33.49% | O10 / OD0 / S0 / AI0 | 45.4237 | 27.2542 | 7 | 3 | 13.5000 | 2018 -18.69% | 17.0403 | 26.2712 | 2.6271 | 26.2712 | 1.3136 | 3.9407 | 44.6949 |
