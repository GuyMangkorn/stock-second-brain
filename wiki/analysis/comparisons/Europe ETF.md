...
กองทุน multi-country ที่มี underlying exposure หลักเป็นหุ้นยุโรป
...
|---|---|---|---:|---:|---:|---|
| FDD | First Trust STOXX European Select Dividend Index Fund | Europe high-dividend equity | 10.86% | 12.37% | 18.51% | [[ETF_AMEX_FDD Performance]] |
| EUFN | iShares MSCI Europe Financials ETF | developed Europe financials sector | 14.36% | 21.63% | 18.15% | [[ETF_NASDAQ_EUFN Performance]] |
...
VEUR (input alias `VFDEF`) มี complete calendar history 2016-2025; `9.66%`
เป็น issuer rolling 10-year NAV TR ณ 2026-07-31, `11.48%` เป็น rounded-input
CAGR ของ official EUR NAV rows 2021-2025 และ `12.06%` เป็น official NAV TR YTD
...
NAV rows และ `12.71%` เป็น official NAV TR YTD ณ 2026-08-26. Fund จ่าย income
...
`18.51%` เป็น official NAV TR YTD ณ 2026-07-31. FDD's tracked index is STOXX
Europe Select Dividend 30 Index; official daily drawdown/recovery ยังไม่ verified.

EUFN `14.36%` เป็น issuer rolling 10-year average annual NAV TR ณ 2026-06-30;
`21.63%` เป็น rounded-input CAGR ของ official calendar rows 2021-2025 และ
`18.15%` เป็น official NAV TR YTD ณ 2026-08-14. Tracked index 5Y annualized
return เท่ากับ fund ที่ `20.44%`; official daily drawdown/recovery ยังไม่ verified.

EUAD ยังไม่มี 10-year หรือ 2021-2025 calendar window เพราะ inception 2024-10-22;
official current YTD ไม่พบใน static issuer capture. Secondary NAV snapshot
`+0.20%` ณ 2026-06-30 เป็น proxy ที่เก็บในหน้ารายกองและ source batch เท่านั้น.

OPPE `12.91%` เป็น issuer rolling 10-year average annual NAV TR ณ 2026-07-31;
...
`11.02%` เป็น official NAV TR YTD ณ 2026-07-31. กองทุนเป็น passive
