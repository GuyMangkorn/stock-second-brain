...
history of verified browser price observations. A cache observation can narrow
the refresh scope but cannot replace a direct quote outside the one-US-trading-
day decision gate.
