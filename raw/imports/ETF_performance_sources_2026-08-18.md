...
- Candidate claims: official rolling 10-year NAV TR `8.21%` as of `2026-06-30`; calendar-derived 2016-2025 cumulative `101.02%` / rounded-input CAGR `7.23%`; 2021-2025 cumulative `81.59%` / CAGR `12.67%`; current official NAV TR YTD `11.50%` as of `2026-08-14`; 2025 best year `34.45%`, 2018 worst year `-14.60%`, and 3-year standard deviation `11.89%` as of `2026-07-31`.

### Source map

| Source | URL/path | Use |
|---|---|---|
| iShares U.S. product page | https://www.ishares.com/us/products/239690/ishares-msci-united-kingdom-etf | identity, exchange, NAV/price, current YTD, rolling returns, holdings, sectors, risk, distributions and official annual rows |
| iShares U.S. factsheet | https://www.ishares.com/us/literature/fact-sheet/ewu-ishares-msci-united-kingdom-etf-fund-fact-sheet-en-us.pdf | fund facts, benchmark, expense ratio and 2021-2025 performance rows as of 2026-06-30 |
| iShares U.S. summary prospectus | https://www.ishares.com/us/literature/summary-prospectus/sp-ishares-msci-united-kingdom-etf-8-31.pdf | passive objective, representative sampling, 80% policy, derivatives allowance and expenses |
| iShares UK professional product page | https://www.ishares.com/uk/professional/en/products/239690/ishares-msci-united-kingdom-etf?shortLocale=en_GB | 2016-2020 annual chart rows displayed to 0.1 percentage point |
...
- Official current snapshot: NAV `$48.11`, closing price `$48.16`, and total net assets `$3,776,373,933` as of 17 Aug 2026. Official NAV TR YTD was `11.50%` as of 14 Aug 2026.
- Official rolling fields as of 30 Jun 2026: 1-year `19.23%`, 3-year annualised `16.76%`, 5-year annualised `11.31%`, 10-year annualised `8.21%`, and since inception annualised `5.99%`.
...
- Current characteristics as of 31 Jul / 14 Aug 2026: 3-year standard deviation `11.89%`, equity beta `0.43`, P/E `18.02x`, P/B `2.40x`; sector weights include Financials `27.65%`, Industrials `14.10%`, Consumer Staples `13.96%`, Health Care `11.98%`, Energy `11.21%`, and Materials `8.10%`.
...
- The official rolling 10-year field independently reports cumulative `120.07%` and CAGR `8.21%` as of 2026-06-30. It is kept separate from the `7.23%` calendar-derived CAGR because the windows and source precision differ.

### Planned durable paths and contents

- Create `wiki/analysis/performance/ETF_NYSE_ARCA_EWU Performance.md` with Thai-first identity/classification, rolling and calendar performance, annual fund/index/S&P table, calculations, current NAV/YTD, risk evidence, source links, canonical breadcrumb and `geography/United-Kingdom` tag.
- Update `wiki/analysis/comparisons/United Kingdom ETF.md` with one EWU row and the rolling/calendar/YTD precision note.
- Update `wiki/analysis/comparisons/ETF Region Index.md` United Kingdom count from `3` to `4`.
- Update `wiki/analysis/performance/ETF Performance Index.md` with EWU coverage, Common Window row, annual comparison row, explanatory note and 2026-08-18 coverage bullet.
- Append one `log.md` workflow bullet for the EWU result.
- No `wiki/entities/ETF_NYSE_ARCA_EWU.md` or `raw/funds/` file is planned because this performance workflow owns the numeric page and no existing EWU ticker hub was found.
...
- PASS: official rolling field is separated from calendar-derived CAGR; 2016-2020 rounded source precision is disclosed; fund/index tracking differences and the S&P 500 common reference are separated and no arithmetic difference is called alpha.
...
- PASS: the complete proposed contents of the performance page, United Kingdom region row, region count, performance-index rows, source batch section and log bullet are specified; all planned wikilinks, breadcrumb and canonical geography tag resolve.
- PASS: no unresolved High/Medium finding blocks the write and no WARNING requiring confirmation remains. Required scheduled audit lines are present: `verification_mode: scheduled-local` and `reviewer_dispatch: not-attempted-by-design`.
