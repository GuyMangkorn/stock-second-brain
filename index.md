...
- 2026-06-10: Refreshed `[[IBM]]` with a fresh market quote source
  ...
  `[[IBM Decision Memo 2026-06-10]]`, and moved the action read to WAIT /
  HOLD-existing-only because the latest quote of USD 277.49 is above the
  source-backed base DCF value of about USD 240.27.
...
- 2026-06-03: Ran full new-ticker decision-grade flow for `[[AXON]]`: created
  ...
  `[[AXON Decision Memo 2026-06-03]]`. P1 was source-note-only; P13 action
  read is WAIT / WATCHLIST-new-capital because Axon is a high-quality public
  safety platform, but the fresh price requires a much larger FCF base than
  official FY2026 FCF guidance verifies.
...
- 2026-05-21: Ran full new-ticker decision-grade flow for `[[GEV]]`: created
  ...
  `[[GEV Decision Memo 2026-05-21]]`. P1 was source-note-only; P13 action read
  is WAIT / AVOID-new-capital because GE Vernova has strong power /
  electrification momentum but current market price already embeds a demanding
  FCF growth path.
...
- 2026-05-21: Ran full new-ticker decision-grade flow for `[[AMAT]]`: created
  ...
  `[[AMAT Decision Memo 2026-05-21]]`. P1 was source-note-only; P13 action
  read is AVOID-new-capital / WAIT-for-better-entry because current valuation
  is far above source-backed FCF DCF despite strong AI-cycle business momentum.
...
| [[IBM]] | IBM | International Business Machines Corporation | NYSE | Q1 2026 | 8 |
...
| [[IBM_market_quote_2026-06-10]] | IBM | market-quote | Latest market quote for valuation refresh | [[IBM Decision Memo 2026-06-10]] |
...
- For `[[AXON]]`, refresh after Q2 2026 results with revenue, ARR, NRR,
  ...
  the WAIT / WATCHLIST-new-capital action read.
...
- For `[[GEV]]`, refresh after Q2 2026 results with attention to segment
  ...
  guidance; refresh price before changing the WAIT / AVOID-new-capital action
  read.
...
- For `[[AMAT]]`, refresh after Q3 FY2026 results with attention to revenue,
  ...
  into cash flow; refresh price before changing the
  AVOID-new-capital / WAIT-for-better-entry action read.
